package com.just.os.multithreadedsolver.multithreaded;

public class MTSudokuValidator {
...
//    };
    ...
    public MTSudokuValidator(int[][] sudoku) {
        this.sudoku = sudoku;
    }

    public MTSudokuValidator(){}
    ...
    public  class IsRowValid extends RowColumnObject implements Runnable {
    ...
    public  class IsColumnValid extends RowColumnObject implements Runnable {
    ...
    public  class Is3x3Valid extends RowColumnObject implements Runnable {
